...
save([experiment(1:8),'_',num2str(neuron_idx),'_WIdata.mat'],'class_id','spiketimes')
...
saveas(gcf,[experiment(1:8),'_',num2str(neuron_idx),'_spkct_spd.fig'])
...
saveas(gcf,[experiment(1:8),'_',num2str(neuron_idx),'_wavelet_spd.fig'])
...
mkdir([rt,'MT/MATLAB/matt_ana/Info/',experiment(1:8),'/Wavelet/']);
saveas(gcf,[experiment(1:8),'_',num2str(neuron_idx),'_spkct_dir.fig'])

figure;imagesc(handles.decode.WVconfusionmatrix);colorbar
title(['confusion matrix from wavelet info for direction: performance ',num2str(handles.decode.WVperf)])
saveas(gcf,[experiment(1:8),'_',num2str(neuron_idx),'_wavelet_dir.fig'])
...
saveas(gcf,[experiment(1:8),'_',num2str(neuron_idx),'_spkct_dirspd.fig'])
figure;imagesc(handles.decode.WVconfusionmatrix);colorbar
title(['confusion matrix from wavelet info for speed and direction: performance ',num2str(handles.decode.WVperf)])
saveas(gcf,[experiment(1:8),'_',num2str(neuron_idx),'_wavelet_dirspd.fig'])
