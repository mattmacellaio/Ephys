...
experiment='ga032715a_dir15_5spds'; %I screwed this date up in recording so maestro files are named ga032714
...
save([experiment,'_unit',num2str(neuron_idx),'_2dtunecurve.mat'],'spk_ct_mean');
%
